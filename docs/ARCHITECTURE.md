...
|----------|-------------|-------------|-------|
| **GitProvider** | `source_type: "git"`, `git_url`, `git_branch` | Cloned repo → `{subpath}/repos` | `~/.yantrix/git_cache/` |
| **ArtifactoryProvider** | `target_type: "artifactory"`, `artifactory_url` | Downloaded JAR → `app_root/repos/SYSTEM` | `~/.yantrix/artifactory_cache/` |
...
- **ArtifactoryProvider sidecar** — `cache_dir/.yantrix_system_path`
