...
Extracts to ~/.yantrix/artifactory_cache/{version}/ and resolves
...
_CACHE_ROOT = Path.home() / ".yantrix" / "artifactory_cache"
...
class ArtifactoryProvider(SourceProvider):
    ...
    def _find_system_path(cache_dir: Path) -> Path | None:
        ...
        Strategy (fastest first):
          1. Read sidecar file `.yantrix_system_path` if it was written by a
